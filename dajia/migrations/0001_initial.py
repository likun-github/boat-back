# Generated by Django 2.0.9 on 2019-04-01 12:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Period',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '健身'), (2, '驾校'), (3, '考研'), (4, '小语种')], verbose_name='产品类别')),
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='periodtoteam', to='dajia.Period')),
            ],
        ),
        migrations.CreateModel(
            name='Production',
        ...
        migrations.AddField(
            model_name='steam',
            name='master',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dajia.User'),
        ),
        migrations.AddField(
            model_name='periodtoteam',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='periodtoteam', to='dajia.Team'),
        ),
        migrations.AddField(
            model_name='period',
            name='production',
